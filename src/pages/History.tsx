...
function DetailPanel({ transfer, onClose }: { transfer: Transfer; onClose: () => void }) {
  return (
...
export default function History() {
  ...
  function matchesDirection(t: Transfer) {
  ...
  function matchesStatus(t: Transfer) {
  ...
  const grouped: Record<string, Transfer[]> = groupByDate(filtered)
