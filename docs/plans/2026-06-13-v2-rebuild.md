...
describe('demo store', () => {
  ...
  it('onboarding lifecycle: new customer starts pending, KYC approves after delay', () => {
    const c = demoStore.createCustomer({ firstName: 'Ada', lastName: 'L', email: 'ada@example.com' })
  ...
  it('reset restores the seed persona', () => {
    demoStore.createCustomer({ firstName: 'Ada', lastName: 'L', email: 'ada@example.com' })
    demoStore.reset()
...
describe('live source', () => {
  ...
  it('creates customers via /v2 with compacted personal block', async () => {
    ...
    await liveSource.createCustomer({ firstName: 'Ada', lastName: 'L', email: 'ada@example.com' })
    expect(mockedPost).toHaveBeenCalledWith('/v2/customers', {
      type: 'individual',
      personal: { firstName: 'Ada', lastName: 'L', email: 'ada@example.com' },
    })
  })
})
```
...
describe('tracked source', () => {
  ...
  it('emits onboarding events', async () => {
    ...
    const events: ActionEvent[] = []
    const off = onAction(e => events.push(e))
    const c = await source.createCustomer({ firstName: 'Ada', lastName: 'L', email: 'a@example.com' })
